...
const Pins = ({ route, navigation, boards, spaces,
  pins, socket, user, error, activeBoardId, setBoardId, profiles }) => {
  ...
  return (
    <View style={styles.container}>
      {space.name === 'Poll' && <Poll />}

      {space.name === 'Roommate' && <VoiceChatItem participants={profiles} />}
