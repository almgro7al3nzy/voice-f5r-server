    ...
    this.state = {
      ...
      sdpConstraints: {
        'mandatory': {
            ...
            // 'OfferToReceiveVideo': this.props.userId === this.props.currentPlayerId ? false : true
  ...
  getLocalStream = () => {
    ...
    mediaDevices.enumerateDevices().then(sourceInfos => {
      ...
      const constraints = {
        // audio: true,
        audio: false,        
        // video: this.props.userId !== this.props.currentPlayerId ? false : {
        //   mandatory: {
...
debugger
  ...
  leaveVoice = () => {
    // disconnect socket
    console.log('LEAVEEEEEEEEEEVIDEO')
    this.socket.close()
