...
import { getSender, getFullDetailsSender } from '../../../config/chatLogics';
...
const ENDPOINT = "https://young-voice.herokuapp.com";
        ...
        if (event.key === 'Enter' && newMessage) {
            ...
            try {
                ...
                const { data } = await axios.post(
                    `${process.env.REACT_APP_BACKEND}/api/message`,
                    {
                        content: newMessage,
                        chatId: selectedChat,
                    },
    ...
    const fetchMessages = async () => {
        ...
        try {
            ...
            const { data } = await axios.get(
                `${process.env.REACT_APP_BACKEND}/api/message/${selectedChat._id}`,
                config
            );
            setMessages(data);
            setLoading(false);
                        ...
                        />
                        {
                            !selectedChat.isGroupChat ?
                                <>
                                    ...
                                    <ProfileModal user={getFullDetailsSender(user, selectedChat.users)} />
                                </>
                                :
                                <>
