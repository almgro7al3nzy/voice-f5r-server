...
class RightBloodPressureCard extends React.Component {
  state = {
    period: 'default',
  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          {<Bloodchart {...this.props} period={this.state.period} Btn={this.state.BPButtonClass} />}
        </CardStyle>
      </div>
    )
  }
...
`
export default RightBloodPressureCard
