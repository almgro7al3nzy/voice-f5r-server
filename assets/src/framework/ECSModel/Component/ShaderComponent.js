...
let ShaderComponent = cc.Class({
    extends: cc.Component,
    editor: CC_EDITOR && {
        executeInEditMode: true,
        requireComponent: cc.Sprite,
        menu: "自定义/ShaderComponent",
    },
    ...
    __preload () {
        ...
        ShaderComponent.ShaderEnum = CustomMaterial.getShaderEnum();
        cc.Class.Attr.setClassAttr(ShaderComponent, 'program', 'enumList', array);
    },
